...
using FootballFieldManagement.Areas.AdminManagement.Models;
...
namespace FootballFieldManagement.Areas.AdminManagement.Controllers
{
    ...
    {
        public FootballFieldManagementContext _context;
        public LoginController(FootballFieldManagementContext context)
        {
            _context = context;
        }
